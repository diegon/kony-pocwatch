function configureNotifications() {
    ...
    var ReadMailObj = kony.notificationsettings.createAction({
        "id": "ReadMail",
        "label": "ReadMail",
        "pspConfig": {
    ...
    var DeleteMailObj = kony.notificationsettings.createAction({
        "id": "DeleteMail",
        "label": "DeleteMail",
        "pspConfig": {
            "activationMode": kony.notificationsettings.ACTIVATION_MODE_FORWARDS,
    ...
    kony.localnotifications.setCallbacks({
        onlinenotification: online_callback,
        offlinenotification: offline_callback
    });
}
